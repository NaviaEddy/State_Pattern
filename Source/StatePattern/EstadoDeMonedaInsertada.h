...
#include "EstadoDeMonedaInsertada.generated.h"

UCLASS()
class STATEPATTERN_API AEstadoDeMonedaInsertada : public AActor, public IEstado
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstadoDeMonedaInsertada();

private:
	//La maquina tragamonedas de este estado
	UPROPERTY()
		class AMaquinaTragamonedasDeCasino* MI_MaquinaTragamonedas;
