...
#include "Estado.h"
#include "EstadoDeDolaresGanados.generated.h"

UCLASS()
class STATEPATTERN_API AEstadoDeDolaresGanados : public AActor, public IEstado
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstadoDeDolaresGanados();

private:
	//La maquina tragamonedas de este estado
	UPROPERTY()
		class AMaquinaTragamonedasDeCasino* DG_MaquinaTragamonedas;
